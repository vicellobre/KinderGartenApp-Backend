...
public class GetTeacherResultTests
{
    [Fact]
    public void ExplicitConversion_ShouldConvertToGetTeacherResult_WhenTeacherIsValid()
    {
        // Arrange
    ...
    public void ExplicitConversion_ShouldThrowArgumentNullException_WhenTeacherIsNull()
    {
        ...
        // Act & Assert
        var exception = Assert.Throws<ArgumentNullException>(() => (GetTeacherResult?)teacher);
