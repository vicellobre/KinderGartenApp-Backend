...
public class RegisterStudentResponseTests
{
    [Fact]
    public void ExplicitConversion_ShouldConvertToRegisterStudentResponse_WhenStudentIsValid()
    {
        // Arrange
    ...
    public void ExplicitConversion_ShouldThrowArgumentNullException_WhenStudentIsNull()
    {
        ...
        // Act & Assert
        var exception = Assert.Throws<ArgumentNullException>(() => (RegisterChildResponse?)student);
